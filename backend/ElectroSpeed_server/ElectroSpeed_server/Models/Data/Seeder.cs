...
namespace ElectroSpeed_server.Models.Data
{
    public class Seeder
    {
        ...
        private async Task SeedUsuariosAsync()
        {
            Usuarios[] usuarios =
            {
                new Usuarios { Name = "Adrian", Password = PasswordHelper.Hash("adrian"), Email = "adrian@electrospeed.es", Rol = "Admin", Direccion = "CPIFP ALAN TURING" },
                new Usuarios { Name = "Hector", Password = PasswordHelper.Hash("hector"), Email = "hector@electrospeed.es", Rol = "Admin", Direccion = "CPIFP ALAN TURING" },
                new Usuarios { Name = "Noe", Password = PasswordHelper.Hash("noe"), Email = "noe@electrospeed.es", Rol = "Admin", Direccion = "CPIFP ALAN TURING" },
                new Usuarios { Name = "Riki", Password = PasswordHelper.Hash("riki"), Email = "riki@electrospeed.es", Rol = "Admin", Direccion = "CPIFP ALAN TURING" },
