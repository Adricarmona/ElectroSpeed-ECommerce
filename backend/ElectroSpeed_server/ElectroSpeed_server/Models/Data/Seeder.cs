    ...
    public class Seeder
    {
        ...
        private async Task SeedBicicletasAsync()
        {
            Bicicletas[] bicicletas =
            {
                ...
                new Bicicletas() { MarcaModelo = "Kona Fire Mountain", Descripcion = "Bicicleta de montaña con suspensión delantera, frenos mecánicos y cuadro de acero.", Stock = 12, Precio = 999, UrlImg = "KonaFireMountain.jpg" },
                new Bicicletas() { MarcaModelo = "Fuji Nevada 27.5", Descripcion = "Bicicleta versátil para montaña y senderismo, equipada con frenos de disco y cambios Shimano.", Stock = 11, Precio = 1200, UrlImg = "FujiNevada27.5.avif" },
                ...
                new Bicicletas() { MarcaModelo = "Kross Level 8.0", Descripcion = "Bicicleta de montaña con cambios Sram y frenos de disco hidráulicos.", Stock = 15, Precio = 1350, UrlImg = "KrossLevel8.jpg" },
